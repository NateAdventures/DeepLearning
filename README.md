...
**Допустимы**, т.к. не меняют геометрию объектов.  
...
**Назначение:** моделирование вариаций положения объекта и условий съёмки.  
...
- **Partial fine-tuning** дал высокий train accuracy, но сопровождался нестабильным `val_loss`, что указывает на риск переобучения.
...
- Test-Time Augmentation не улучшил итоговую точность.
